...
fn Page() -> impl IntoView {
    view! {
        <h2 id="ridge-racer-ds-burning-nightmare">"Ridge Racer DS: Burning Nightmare"</h2>
        <p>
        ...
        <p>
            <img
                src=internal_path(
                    "/assets/images/pages/projects/guides/ridge_racer_ds_unlock_burning_nightmare/burning_nightmare.png",
                )
                alt="Burning Nightmare"
            />
        </p>
        <p>
        ...
        <h3 id="existing-strategies">"Existing Strategies"</h3>
        <p>
            "Searching for how to beat this car has NOT been fruitful. There's "
            <a href="https://www.supercheats.com/nintendods/questions/ridgeracerds/318662/how-do-beat-the-burning-nightm.htm">
                "this thread"
            </a>
            " which has no responses. There are many generic \"here are some ridge racer cheats\" pages. Also not helpful."
        </p>
        <p>
        ...
        <ul>
            <li>
                <a href="https://www.youtube.com/watch?v=bGAiPlE4b8M">
                    "Ridge Racer 64 Lizard Nightmare Car Attack (Real Hardware)"
                </a>
            </li>
            <li>
                <a href="https://www.youtube.com/watch?v=omKdGPI8zvA">
                    "Ridge Racer 64 - Lizard Nightmare Car Attack"
                </a>
            </li>
        </ul>
        ...
        <p>
            <img
                src=internal_path(
                    "/assets/images/pages/projects/guides/ridge_racer_ds_unlock_burning_nightmare/atomic_purple.png",
                )
                alt="Atomic Purple"
            />
            <img
                src=internal_path(
                    "/assets/images/pages/projects/guides/ridge_racer_ds_unlock_burning_nightmare/dk_team_racing.png",
                )
                alt="DK Team Racing Purple"
            />
        </p>
        <p>"They look pretty, have decent handling, good acceleration, all around solid cars."</p>
        <p>"They are not fast enough."</p>
        <p>"The only car fast enough to hit the times we need is Terrazi Terrific."</p>
        <p>
            <img
                src=internal_path(
                    "/assets/images/pages/projects/guides/ridge_racer_ds_unlock_burning_nightmare/terrazi_terrific.png",
                )
                alt="Terrazi Terrific"
            />
        </p>
        <p>
        ...
        <p>"It Worked! It took like 15 hours of practice total but it worked!"</p>
        <p>
            <img
                src=internal_path(
                    "/assets/images/pages/projects/guides/ridge_racer_ds_unlock_burning_nightmare/victory_showing_car.jpg",
                )
                alt="Burning Nightmare"
                style:width="200px"
            />
